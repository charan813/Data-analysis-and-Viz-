...
def myplot(data,playerlist=Players):
    Col={"KobeBryant":'Black',"JoeJohnson":'Red',"LeBronJames":"Green","CarmeloAnthony":"blue","DwightHoward":"Yellow","ChrisBosh":"Magenta","ChrisPaul":"red","KevinDurant":"blue","DerrickRose":"green","DwayneWade":"magenta"}
    Mrk={"KobeBryant":'v',"JoeJohnson":'^',"LeBronJames":"p","CarmeloAnthony":"P","DwightHoward":"h","ChrisBosh":"X","ChrisPaul":"d","KevinDurant":"8","DerrickRose":"1","DwayneWade":"."}
    for name in playerlist:
        plt.plot(data[Pdict[name]],ls='--',c=Col[name],marker=Mrk[name],label=Players[Pdict[name]])
...
# def myplot(data,playerlist=Players): #data is the list we are looking at, playerlist is set to default.
# #color and marker dictionaries defined
#     Col={"KobeBryant":'Black',"JoeJohnson":'Red',"LeBronJames":"Green","CarmeloAnthony":"blue","DwightHoward":"Yellow","ChrisBosh":"Magenta","ChrisPaul":"red","KevinDurant":"blue","DerrickRose":"green","DwayneWade":"magenta"}
#     Mrk={"KobeBryant":'v',"JoeJohnson":'^',"LeBronJames":"p","CarmeloAnthony":"P","DwightHoward":"h","ChrisBosh":"X","ChrisPaul":"d","KevinDurant":"8","DerrickRose":"1","DwayneWade":"."}
# #Loop to draw plot for all players in playerlist    
#     for name in (playerlist):
#         plt.plot(data[Pdict[name]],c=Col[name],ls='--',marker=Mrk[name],ms=4,label=Players[Pdict[name]])
    
#     plt.legend(loc='upper left',bbox_to_anchor=(1,1))#ensuring legend is on top right outside the plot
#     plt.xticks(list(range(0,10)),Seasons)
#     plt.show()
